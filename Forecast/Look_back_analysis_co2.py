...
emission_name = 'CO2 content in the raw gas (preheater outlet)'
...
for look_back_trial in tqdm(range(5,125,5)):
    ...
    for i in range(len(minutely)):
        ...
        if (val <= 200  or val >= 350):       ##### ***** change here if you want to exclude zeros !
...
pd.DataFrame({'mae': df_mae, 'mape':df_mape}).to_csv('/home/m3rg2000/Junaid_temporary/saved_data/forecast/co2/look_back_analysis_co2_2hr.csv')